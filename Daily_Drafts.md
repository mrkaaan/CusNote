...
机械臂赠送3个垫圈（薄 中厚 最厚）
薄垫圈使用在洗衣机水龙头，
中厚垫圈用在外丝水龙头（使用转换头安装也是用中厚垫圈），
最厚的圈用在内丝水龙头。


机械臂内丝龙头安装使用最厚的垫圈安装漏水的话，可以使用以下2个方法：
使用中号的垫圈(小头朝下)，上面再放个最薄的垫圈，然后螺纹处缠5-6圈生料带
使用中厚的垫圈+客户龙头原装的垫圈


我现在需要看一段粤语歌词，我用pixpin悬浮工具把文字悬浮在桌面上看，但是粤语我不懂，需要粤语注音，我需要你使用html的ruby给每个字标注粤语读音写个界面（因为pixpin支持html格式复制），同时要保留原本的换行，不用做额外的样式
黑街的孩儿, 夜夜也爱在此,
玻璃樽, 空罐子,
野火烧去憾事,
阴森的零时, 造就畅快日子.
